...
*/
	...
	#define _GRAMHEIGH    128//160 *see Note 3
	#define _GRAMSIZE		_GRAMWIDTH * _GRAMHEIGH//*see note 1
	#define __COLORSPC		1// 1:GBR - 0:RGB
	#define __GAMMASET3		//uncomment for another gamma
	#define __OFFSETY		  1 // *see note 2,3(was 32 2019-06-21 db +++) Also changed name to OFFSETY	
	#define __OFFSETX		  2 // New 2019-06-23 DB +++
	//Tested!
...
*/
	...
	#define __COLORSPC		1// 1:GBR - 0:RGB
	#define __GAMMASET1		//uncomment for another gamma
  #define __OFFSETY		  0 // *see note 2,3 (was 32 2019-06-21 db +++) Also changed name to OFFSETY	
	#define __OFFSETX		  0 // New 2019-06-23 DB +++
#else
...
/*
	...
	Note 2: This is the offset between image in RAM and TFT. In that case 160 - 128 = 32; See Note 3 below for an update.
	
	Note 3: 2019-06-24 - I noticed the clearScreen and plotting functions left trash at 
	        ...
	        work (for me), set screen height to 128 and tweaked the clearScreen function. --> see TFT_ILI9163C.cpp 
